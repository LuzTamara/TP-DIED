...
import frsf.isi.died.app.controller.BusqControllerVid;
import frsf.isi.died.tp.modelo.productos.Video;

public class BusqPanelVid extends JPanel {
String[] ordenamiento = {"Titulo", "Calificacion", "Precio", "Fecha de publicacion", "Relevancia"};
	...
	private BusqControllerVid controller;
	...
	public void construir() {
		...
		btnBusqTitulo.addActionListener(e ->{
			controller.buscarVideo(1, txtBusqTitulo.getText(), null, (String) ordenamientoTitulo.getSelectedItem());
		...
		btnBusqCalific.addActionListener(e -> {
			controller.buscarVideo(2, txtBusqCalific.getText(), null, (String) ordenamientoCalific.getSelectedItem());
		...
		btnBusqTema.addActionListener(e ->{
			controller.buscarVideo(3, txtBusqTema.getText(), null, (String) ordenamientoTema.getSelectedItem());
			txtBusqTema.setText("");
		}
		);
		gridConst.gridx=8;
		...
		btnBusqRango.addActionListener(e ->{
			 LocalDate desde = LocalDate.of((int)Integer.valueOf(txtBusqRangoDesdeAAAA.getText()),
					(int)Integer.valueOf(txtBusqRangoDesdeMM.getText()),
					(int)Integer.valueOf(txtBusqRangoDesdeAAAA.getText()));
			 LocalDate hasta = LocalDate.of((int)Integer.valueOf(txtBusqRangoHastaAAAA.getText()),
						(int)Integer.valueOf(txtBusqRangoHastaMM.getText()),
						(int)Integer.valueOf(txtBusqRangoHastaAAAA.getText()));
			 
			controller.buscarVideo(3, desde, hasta, (String) ordenamientoTema.getSelectedItem());
	...
	public BusqControllerVid getController() {
		return controller;
	}

	public void setController(BusqControllerVid controller) {
