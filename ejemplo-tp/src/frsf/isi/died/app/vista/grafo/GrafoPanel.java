        ...
        addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent event) {
                if (event.getClickCount() == 2 && !event.isConsumed()) {
                    event.consume();
                    String seleccion = controller.getSeleccionBarraDesplegable();
                    List<MaterialCapacitacion> materiales = controller.listaVertices();
                    Object[] mats = controller.materialesPorTema(materiales, seleccion).toArray();
