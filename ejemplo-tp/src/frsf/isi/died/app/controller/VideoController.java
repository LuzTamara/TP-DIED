...
public class VideoController {
	...
	public void agregarVideo(String titulo,Double costo, Integer duracion, String tema, Integer calificacion, String relevancia, LocalDate fechaPublicacion) {	
		Video v = new Video(0,titulo, costo, duracion, tema, calificacion, relevancia, fechaPublicacion) ;
