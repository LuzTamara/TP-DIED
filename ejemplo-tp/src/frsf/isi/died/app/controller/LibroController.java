...
public class LibroController {
	...
	public void agregarLibro(String titulo,Double costo,Double precio,Integer paginas, String tema, Integer calificacion, String relevancia, LocalDate fechaPublicacion) {	
		Libro l = new Libro(0,titulo, costo, precio, paginas, tema, calificacion, relevancia, fechaPublicacion);
